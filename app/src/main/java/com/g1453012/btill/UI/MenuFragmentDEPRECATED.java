...
public class MenuFragmentDEPRECATED extends Fragment {
    ...
    private void launchBalanceDialog() {
        ...
        Bitmap mBitmap = mBTillController.generateQR(mBTillController.getWallet());
    ...
    private void launchPaymentRequestDialog(final Protos.PaymentRequest request, final Menu menu) {
        ...
        if (mSession != null) {
            mOrderID.setText("" + menu.getOrderId());
